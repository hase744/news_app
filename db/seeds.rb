...
channel_seeds = [
    ...
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@Invest_and_Living", "categories" => %w(military)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@primenews/", "categories" => %w(world politics military)},
    ...
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@Bungeishunju", "categories" => %w(politics military)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@watanabetetuya-show", "categories" => %w(politics economy military)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@News_ABEMA", "categories" => %w(politics economy world military trend)},
    ...
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@ChGrandStrategy", "categories" => %w(politics technology economy world military)},
    ...
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@nikkanshunshun", "categories" => %w(politics economy world military trend)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@toranomonnews", "categories" => %w(politics economy world military trend)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@user-le9qv3yz9r", "categories" => %w(politics economy world military trend)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@gototatsuya", "categories" => %w(economy)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@NikkeiCNBC", "categories" => %w(economy technology military)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@ReutersJapan", "categories" => %w(world economy technology)},
    {"youtube_id"=>"", "url"=>"https://www.youtube.com/@aichi-news", "categories" => %w(economy technology business military)},
